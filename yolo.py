...
class YOLO(object):
    _defaults = {
        "model_path": 'logs/2020714/trained_weights_final.h5',
    ...
    def detect_image(self, image):
        ...
        print("yolo--116",image_data.shape)
        image_data /= 255.
...
def detect_video(yolo, video_path, output_path=""):
    import cv2
    vid = cv2.VideoCapture('F:/新建文件夹/lunwen/12.mp4') #0为运行摄像头
    if not vid.isOpened():
